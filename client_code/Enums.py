...
class AlimentoGrupoEnum(BaseEnum):
    ...
    __options__ = {
        'BEBIDA': {'nome': 'Bebidas', 'codigo': 'B', 'icon': 'fa:glass-water', 'color': '#201206'}, # Bebidas
        'SUCO': {'nome': 'Sucos', 'codigo': 'S', 'icon': 'fa:blender', 'color': '#FFE5B4'}, # Frutas e derivados
        'FRUTA': {'nome': 'Frutas', 'codigo': 'F', 'icon': 'fa:apple-whole', 'color': '#B24638'}, # Frutas e derivados
        ...
        'CEREAL': {'nome': 'Cereais', 'codigo': 'C2', 'icon': 'fa:wheat-awn', 'color': '#F5DEB3'}, # Cereais e derivados
